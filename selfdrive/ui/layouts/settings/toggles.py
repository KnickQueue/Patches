...
DESCRIPTIONS = {
  ...
  "ElonMode": tr_noop("Enable 'Elon Mode' to disable driver monitoring alerts."),
  "ShowDmDebug": tr_noop("Show real-time driver monitoring metrics on the UI for debugging."),
...
class TogglesLayout(Widget):
  def __init__(self):
    ...
    self._toggle_defs = {
      ...
      "ShowDmDebug": (
        lambda: tr("Show DM Debug"),
        DESCRIPTIONS["ShowDmDebug"],
        "monitoring.png",
        False,
      ),
    }
