...
class IQUIState:
  def __init__(self):
    ...
    self.sm_services_ext = [
      "iqModelManager", "iqState", "iqPlan",
      "gpsLocation", "liveTorqueParameters", "iqCarState",
      "iqLiveMapData", "iqCarParams", "liveDelay"
    ]
  ...
  def update_params(self) -> None:
    ...
    self.elon_mode = self.params.get_bool("ElonMode")
    self.show_dm_debug = self.params.get_bool("ShowDmDebug")
