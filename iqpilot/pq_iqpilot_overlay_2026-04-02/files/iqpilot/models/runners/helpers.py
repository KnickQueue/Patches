...
from openpilot.iqpilot.models.runners.constants import ModelType, POLICY_MODEL_TYPES
...
def get_model_runner() -> ModelRunner:
  ...
  if bundle and bundle.models:
    ...
    if ModelType.vision in model_types or bool(model_types & POLICY_MODEL_TYPES):
