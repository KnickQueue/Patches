...
import numpy as np
from openpilot.iqpilot.modeld_v2.parse_model_outputs import Parser as CombinedParser
from openpilot.iqpilot.modeld_v2.parse_model_outputs_split import Parser as SplitParser
from openpilot.iqpilot.models.runners.constants import ModelType, NumpyDict, ON_POLICY_MODEL_TYPE
from openpilot.iqpilot.models.runners.model_runner import ModularRunner
...
class PolicyTinygrad(ModularRunner, ABC):
  ...
  def __init__(self):
    ...
    self.parser_method_dict[ON_POLICY_MODEL_TYPE] = self._parse_policy_outputs
