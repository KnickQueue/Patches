...
from openpilot.iqpilot.models.runners.constants import CLMemDict, FrameDict, NumpyDict, ModelType, ShapeDict, CUSTOM_MODEL_PATH, SliceDict, ON_POLICY_MODEL_TYPE
...
class TinygradSplitRunner(ModelRunner):
  ...
  def __init__(self):
    ...
    policy_model_type = ModelType.policy if self.models.get(ModelType.policy) else ON_POLICY_MODEL_TYPE
    self.policy_runner = TinygradRunner(policy_model_type)
