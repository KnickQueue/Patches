...
class Colors:
  ...
  # Status colors
  GOOD = rl.Color(9, 185, 169, 255)      # #09b9a9
  WARNING = rl.Color(185, 9, 97, 255)    # #b90961
  DANGER = rl.Color(185, 9, 97, 255)     # #b90961
...
class Sidebar(Widget):
  ...
  def _draw_buttons(self, rect: rl.Rectangle):
    ...
    if ui_state.started:
      ...
      rl.draw_texture(self._flag_img, int(HOME_BTN.x), int(HOME_BTN.y), tint)
    else:
