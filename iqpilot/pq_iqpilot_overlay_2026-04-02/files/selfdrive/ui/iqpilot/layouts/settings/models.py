...
from openpilot.iqpilot.models.runners.constants import CUSTOM_MODEL_PATH, ON_POLICY_MODEL_TYPE
...
class ModelsLayout(Widget):
  ...
  def _initialize_items(self):
    ...
    self.lane_turn_value_control = option_item(tr("Adjust Lane Turn Speed"), "LaneTurnValue", 500, 2000,
  ...
  def _handle_bundle_download_progress(self):
    labels = {custom.IQModelManager.Model.Type.supercombo: self.supercombo_label,
              ...
              ON_POLICY_MODEL_TYPE: self.policy_label}
