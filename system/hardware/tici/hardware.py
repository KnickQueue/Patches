...
class Tici(HardwareBase):
  ...
  def get_network_type(self):
    try:
      ...
      primary_state = primary_connection.Get(NM_CON_ACT, 'State', dbus_interface=DBUS_PROPS, timeout=TIMEOUT)

      if primary_state != NMActiveConnectionState.ACTIVATED:
      ...
      if primary_type == '802-3-ethernet':
        ...
        for conn in active_connections:
          ...
          state = c.Get(NM_CON_ACT, 'State', dbus_interface=DBUS_PROPS, timeout=TIMEOUT)
          if tp == 'gsm':
